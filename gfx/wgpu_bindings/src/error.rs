    ...
    impl HasErrorBufferType for CreateExternalTextureError {
        fn error_type(&self) -> ErrorBufferType {
            match self {
                ...
                CreateExternalTextureError::CreateBuffer(e) => e.error_type(),
                CreateExternalTextureError::CreateTexture(e) => e.error_type(),
                CreateExternalTextureError::CreateTextureView(e) => e.error_type(),
