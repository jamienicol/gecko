...
class AndroidImage {
 public:
  ...
  // Retrieves the Image's hardware buffer. This does *not* take an explicit
  // reference. The buffer remains owned by the image and any explicit
  // references that are taken must be released prior to the Image itself being
  // released.
